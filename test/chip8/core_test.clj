...
(deftest op-00E0
  ...
  (write-fb 0 0 [0xFF])
  (is (= (read-fb 0 0) (unchecked-byte 0xFF)))
  (evaluate 0x00E0)
  (is (= (read-fb 0 0) 0)))
...
(deftest op-dxyn
  (println (:doc (meta #'opcode-dxyn)))
  (write-reg :I 0x200)
  (write-mem 0x200 2r11111111)
  (evaluate 0xd001)
  (testing "Simple display no overflow" (is (= (read-fb 0 0)) 2r11111111))
  (reset)
  (write-reg :I 0x200)
  (write-mem 0x200 2r11111111)
  (write-mem 0x201 2r10101010)
  (evaluate 0xd002)
  (testing "Multiple sprites no overflow"
    (is (= (read-fb 0 0)) 2r11111111)
    (is (= (read-fb 0 1)) 2r10101010))
  (reset)
  (write-reg :I 0x200)
  (write-mem 0x200 2r11111111)
  (write-reg 0x0 0x3F)
  ...
  (evaluate 0xd011)
  (testing "Overflow X"
    (is (= (read-fb 60 0)) 2r11111111)
    (is (= (read-fb 0 0)) 2r11110000))
  (reset)
  (write-reg :I 0x200)
  (write-mem 0x200 2r11111111)
  (write-mem 0x200 2r10101010)
  (write-reg 0x0 0)
  (write-reg 0x1 0x1F)
  (evaluate 0xd012)
  (testing "Overflow Y"
    (is (= (read-fb 0 31)) 2r11111111)
    (is (= (read-fb 0 0)) 2r10101010)))
